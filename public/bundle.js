...
var data = {
    productos: [
        ...
        },
        {
            ...
            descripcion: 'consider your project',
            precio: 450.0,
            colores: ['negro', 'rojo', 'amarillo'],
            tamaños: ['1,5', '2', '2,5', '3', '3,5', '4']
        }
...
let carrito = [];
const formatearMoneda = new Intl.NumberFormat('es-HN', {style: 'currency', currency: 'USD'});
const notificacion = document.getElementById('notificacion');

const renderCarrito = () => {
    ventanaCarrito.classList.add('carrito--active');

    // Eliminamos todos los productos anteriores para construir el carrito
    ...
    if(carrito.length < 1) {
        ...
        // Creamos una plantilla del codigo
        const plantillaProducto = `
            <div class="carrito__producto-info">
                <img src="${thumbSrc}" alt="" class="carrito__thumb" />
                <div>
                    <p class="carrito__producto-nombre">
                        <span class="carrito__producto-cantidad">${productoCarrito.cantidad} x </span>${productoCarrito.nombre}</p>
                    </p>
